...
제22조(회원의 의무)
① 이용고객은 회원 가입 신청 시 모든 사항을 사실에 근거하여 기재하여야 하며, 허위의 정보를 등록할 경우 또는 타인 명의의 ID에 대해서 일체의 권리를 주장할 수 없습니다.
② 회원은 회사가 제공하는 서비스를 이용함에 있어 다음 각 호의 행위 또는 다음 각호에 해당 하는 내용을 목적으로 하거나 의도하는 행위를 하여서는 안됩니다.
...
7. 결제수단 명의자의 동의나 승낙 없이 결제 수단을 무단 도용하여 요금 결제
8. 비정상적인 경로를 통한 넥슨캐시 충전, ID 및 아이템 거래 등
9. 회사의 지적재산권, 제3자의 지적재산권, 초상권 등 기타 권리를 침해
10. 회사의 승인을 받지 않고 다른 회원의 개인정보를 수집, 저장, 유포, 게시
11. 프로그램의 버그를 악용
12. 회사 서비스 운영을 고의로 방해하거나 서비스의 안정적 운영을 방해할 수 있는 정보 및 수신자의 명시적인 수신거부 의사에 반하여 광고성 정보를 전송
13. 타인으로 가장하는 행위 및 타인과의 관계를 허위로 명시
14. 음란, 저속한 정보를 교류, 게재하거나 음란사이트를 연결(링크), 승인되지 않은 광고 및 홍보물 게재
15. 재물을 걸고 도박하는 등 사행 행위를 유도하거나 참여하는 경우
16. 수치심이나 혐오감 또는 공포심을 일으키는 말이나 음향, 글이나 화상 또는 영상을 상대방에게 전송, 도달, 유포
17. 서비스에 게시된 정보를 변경하는 행위
18. 관련 법령에 의하여 그 전송 또는 게시가 금지되는 정보(컴퓨터프로그램) 또는 컴퓨터소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해, 파괴할 목적으로 고안된 소프트웨어 바이러스, 기타 다른 컴퓨터 코드, 파일, 프로그램을 포함하고 있는 자료를 전송, 게시, 유포, 사용
19. 회사의 직원이나 운영자를 가장하거나 사칭하여 또는 타인의 명의를 도용하여 글을 게시하거나 메일을 발송하는 행위
20. 기타 공공질서 및 미풍양속을 위반하거나 불법적, 부당한 행위 및 관계법령에 위배되는 행위
...
⑤ 회사는 본 조 제2항부터 제4항 및 다음 각 호의 어느 하나에 해당하는 행위의 구체적인 유형을 운영정책에서 정할 수 있으며, 회원은 이를 준수할 의무가 있습니다.
1. 회원의 계정명, 캐릭터명, 혈맹명, 길드명, 기타 회원이 직접 정할 수 있는 명칭에 대한 제한
2. 채팅내용과 방법에 대한 제한
3. 게시판이용에 대한 제한
4. 게임플레이방법에 대한 제한
5. 기타 회원의 게임서비스 이용에 대한 본질적 권리를 침해하지 않는 범위 내에서 회사가 게임서비스 운영상 필요하다고 인정되는 사항
⑥ 회원은 홈페이지의 공지사항을 수시로 확인하여야 합니다.
제23조(개인정보의 관리 등)
① 회원은 본 서비스의 이용을 위해 자신의 개인정보를 성실히 관리해야 하며 회원이 입력한 개인 정보에 변동사항이 있을 경우 이를 변경해야 합니다. 회원의 개인정보변경이 지연되거나 누락되어 발생되는 손해는 회원의 책임으로 합니다.
② 회원은 자신의 ID와 비밀번호가 노출되지 않도록 최선의 주의를 다하여야 합니다. 회원의 과실로 인해 ID와 비밀번호가 노출되어 발생하는 피해 및 결과에 대한 책임은 회원에게 있습니다.
③ 회원이 자신의 서비스 이용 권한 또는 서비스 이용 계약상의 지위를 제3자에게 양도, 대여하거나 담보로 제공하여 야기된 결과에 대한 책임은 해당 회원에게 있습니다.
④ 회원은 본인의 ID 및 비밀번호를 제3자에게 이용하게 해서는 안되며, 회원 본인의 ID 및 비밀번호를 도난 당하거나 제3자가 사용하고 있음을 알게 된 때에는 즉시 회사에 통보하고 회사의 안내가 있는 경우 그에 따라야 합니다.
...
고객센터
E-mail: PShelp@nexon-networks.co.kr
...
④ 회사는 회원이 다음 각 호에 해당하는 경우, 회사는 제 11조 제2항의 방법 또는 기타 유효한 수단을 통해 해당 회원에게 통지하고 회원자격을 박탈할 수 있습니다.
...
6. 본 약관 제22조 제2항의 제1, 4, 7, 11, 17, 18, 20호에 기재된 행위를 한 경우
7. 본 조 제3항에 해당하는 행위를 계속하여 회사로부터 2회 이상 서비스 이용 중지 또는 제한을 받은 경우
⑤ 회원은 다음 각호의 방법을 통해 구매한 넥슨 캐시, 유료 아이템을 전부 반환하여야 합니다. 이 때 일부 사용, 소모, 양도 등으로 전액 반환이 불가능한 경우, 회사는 회원이 보유한 넥슨 캐시를 회수하고, 그 대가가 모두 반환될 때까지 회원의 게임 이용을 제한하거나 회원이 보유한 계정의 게임 내 아이템, 게임머니 등 거래를 제한할 수 있습니다. 만약 회수되어야 하는 넥슨캐시보다 현재 보유한 넥슨캐시가 적은 경우 회사는 회원 명의의 다른 계정에 대해서도 본 항을 적용할 수 있습니다.
1. 회원이 본 약관 제22조 제2항 8호를 위반하는 경우
2. 결제도용, 명의도용, 사기 등과 연관된 경우
3. 기타 관계법령을 위반한 경우
⑥ 회원이 본 조 제3항 또는 제4항에 따라 서비스 이용이 제한되거나 회원 자격이 박탈되는 경우, 아이템 및 캐시의 환불은 불가능합니다.
⑦ 회사는 본 조 제3항 및 제4항, 게임별 운영 정책에서 제재사유에 해당하는 불법행위를 반복적으로 수행하는 이용자의 경우, 회원 자격을 박탈하고 동일한 신상정보로 재가입하는 것을 제한할 수 있습니다.
⑧ 회사는 본 조 제4항을 적용함에 있어 회사가 적절하다고 판단하는 경우 제3항의 조치로 경감할 수 있습니다.
⑨ 회사는 회원의 ID가 부당한 목적으로 사용되는 것을 방지하고 보다 원활한 서비스 제공을 위하여 다음의 요건을 모두 충족하는 경우에 한하여 해당 ID를 휴면 ID로 분류하고, ID 및 계정 등의 정보를 삭제할 수 있습니다.
1. 각 게임별 운영 정책에서 정한 일정 기간 이상 접속 기록이 없는 회원의 ID
2. 유료로 구매한 넥슨 캐시 또는 유효 기간, 사용 기간이 남아 있는 유료 아이템이 상기 1항의 ID에 존재 하지 않는 경우
⑩ 본 조 제7항과 회사가 개별적으로 정한 게임 이용약관이 충돌하는 경우 개별 게임 이용약관이 우선 적용됩니다.
⑪ 회원은 상기의 조치에 대하여 회사가 정한 절차에 따라 이의신청을 할 수 있습니다.
⑫ 회원의 서비스 이용 해지, 회원박탈 등으로 인해 회원과 회사의 서비스 이용 계약이 종료되는 경우, 관계법령에서 정하는 경우를 제외하고 회사는 보다 나은 서비스 환경의 유지 등을 위하여 ID 및 해당 ID와 관련한 모든 정보를 삭제할 수 있습니다. 따라서 회원은 서비스 이용 계약 종료 이전에 보관이 필요한 정보는 별도로 백업하여야 하며, 회사는 이용계약 종료 이후 회원의 ID관련 정보 및 콘텐츠 삭제로 인한 책임을 부담하지 않습니다.
⑬ 회원 탈퇴가 완료되면, 탈퇴 후 일정 기간 내 회원 가입이 불가능할 수 있습니다.
제25조(미성년자 법정대리인의 계약취소권)
미성년자인 회원이 그 법정대리인의 동의를 받지 않고 요금결제 등 의무부담행위를 한 경우, 미성년자인 회원 또는 그 미성년자의 법정대리인은 관련법령에 따라 해당 계약을 취소할 수 있습니다. 단, 미성년자의 사술로 인한 경우는 제외됩니다.
...
⑨ 회사는 회원이 서비스를 이용하면서 취득한(회사를 통해 직접 유료 구매한 것은 제외) 등급, 아이템, 콘텐츠 등의 손실에 대해서 회사 또는 회사 직원의 고의 또는 중대한 과실로 인한 경우를 제외하고는 책임을 부담하지 않습니다.
...
제28조(이의신청 절차)
회원은 서비스를 이용함에 있어 발생한 사안에 대한 이의 또는 본 약관과 관련한 이의를 회사가 마련하는 고객센터에 할 수 있으며, 회사는 고객의 이의가 정당하다고 인정되는 때에는 그에 상응하는 조치를 취합니다.
...
부칙1.
본 약관은 2012년 11월 12일부터 시행합니다.

부칙2.
본 약관은 2013년 4월 15일부터 시행합니다.

부칙3.
본 약관은 2013년 6월 7일부터 시행합니다.

부칙4.
본 약관은 2014년 4월 15일부터 시행합니다.

부칙5.
본 약관은 2014년 5월 21일부터 시행합니다.

부칙6.
본 약관은 2016년 6월 7일부터 시행합니다.

부칙7.
본 약관은 2016년 8월 1일부터 시행합니다.

부칙8.
본 약관은 2017년 1월 12일부터 시행합니다.

부칙9.
본 약관은 2017년 10월 27일부터 시행합니다.

부칙10.
본 약관은 2018년 7월 17일부터 시행합니다.

부칙11.
본 약관은 2019년 4월 25일부터 시행합니다.

부칙12.
본 약관은 2019년 7월 4일부터 시행합니다.

부칙13.
본 약관은 2020년 8월 13일부터 시행합니다.

부칙14.
본 약관은 2020년 12월 3일부터 시행합니다.
</body>
</html>